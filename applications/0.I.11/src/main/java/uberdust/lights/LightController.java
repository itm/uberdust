package uberdust.lights;


import org.apache.log4j.Logger;
import org.apache.log4j.PropertyConfigurator;
import uberdust.communication.RestClient;
import uberdust.lights.timers.LastReadingTask;
...
public class LightController {
    ...
    private final String READINGS_LINK =
            new String("http://gold.cti.gr:8080/uberdust/rest/testbed/1/node/urn:wisebed:ctitestbed:0x1ccd/capability/urn:wisebed:node:capability:pir");
    ...
    public long lastPirEvent() {
        final String str = RestClient.getInstance().callRestfulWebService("http://gold.cti.gr:8080/uberdust/rest/testbed/1/node/urn:wisebed:ctitestbed:0x1ccd/capability/urn:wisebed:node:capability:pir/latestreading");
