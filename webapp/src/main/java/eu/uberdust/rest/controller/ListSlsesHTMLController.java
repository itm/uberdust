 ...
 */
public final class ListSlsesHTMLController extends AbstractRestController {
     ...
     * Logger.
     */
    private static final Logger LOGGER = Logger.getLogger(ListSlsesHTMLController.class);

    /**
     * Constructor.
     */
    public ListSlsesHTMLController() {
        super();
